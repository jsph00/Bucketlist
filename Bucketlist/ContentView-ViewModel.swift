...
extension ContentView {
    @MainActor class ViewModel: ObservableObject {
        @Published var mapRegion = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 40, longitude: -75), span: MKCoordinateSpan(latitudeDelta: 25, longitudeDelta: 25))
